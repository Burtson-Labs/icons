...
<AgentLoop size={20} strokeWidth={1.75} aria-label="Agent loop" />`,
  ...
  codeBlock(
    'MUI',
    'tsx',
    `// An MUI SvgIcon: fontSize, color and sx work as on @mui/icons-material
import { AgentLoop } from '@burtson-labs/icons/mui/agent-loop';

<AgentLoop fontSize="small" color="primary" titleAccess="Agent loop" />`,
  ),
  codeBlock(
    'JavaScript',
    'js',
