...
import MuiSingle from '../dist/mui/agent-loop.js';
import { AgentLoop as MuiAgentLoop, type MuiIconProps } from '../dist/mui.js';
...
const mui: MuiIconProps = { fontSize: 'small', color: 'primary', title: 'Agent', strokeWidth: 1.5 };
export const views = [
  <ShieldProof key="a" {...props} />,
  <Custom key="b" className="x" />,
  <MuiAgentLoop key="c" {...mui} />,
  <MuiSingle key="d" titleAccess="Agent" />,
  a,
  b,
];
